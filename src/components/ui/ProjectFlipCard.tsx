...
export default function ProjectFlipCard({
    ...
    return (
        <div
            className="relative w-96 h-96 group [perspective:2000px]"
            ...
            >
                ...
                <div
                    className={cn(
                        ...
                        "bg-[#010101] dark:bg-zinc-900",
                        "border border-zinc-700 dark:border-zinc-800/50",
                ...
                >
                    <div className="relative h-full overflow-hidden bg-[#111111] flex flex-col items-center justify-center">
                        <h3 className="text-2xl font-satoshi font-semibold text-[#ffffe5] leading-snug tracking-tighter transition-all duration-500 ease-out-expo group-hover:translate-y-[-4px]">
                                    {title}
                      </h3>
                       
                                <p className="text-sm text-zinc-600 text-left dark:text-zinc-200 line-clamp-2 tracking-tight transition-all duration-500 ease-out-expo group-hover:translate-y-[-4px] delay-[50ms]">
                                    {subtitle}
                                </p>
                    </div>
                ...
                >
                    <div className="flex-1 space-y-6">
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-zinc-600 dark:text-zinc-400 tracking-tight transition-all duration-500 ease-out-expo group-hover:translate-y-[-2px] line-clamp-3">
                                {description}
                            </p>
                        </div>
