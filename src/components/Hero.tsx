    ...
    <div className=" flex flex-col w-screen text-center overflow-x-hidden sm:pr-48">
      <div className="flex flex-col h-screen w-screen sm:px-48 px-6 ">
        <div className="flex flex-col h-screen justify-start items-start">
          <div          
          className=" flex sm:flex-row flex-col-reverse sm:justify-between justify-start sm:gap-48 gap-0  px-2 py-20 text-gray-200 h-1/2 text-left z-20 font-satoshi w-full"
        >
          <p className="sm:text-7xl sm:scale-150 sm:px-32 text-4xl sm:text-left text-left">
        ...
        <p className=" sm:text-left text-left font-satoshi font-light sm:pt-28 pt-12 pb-12 sm:pb-0">
