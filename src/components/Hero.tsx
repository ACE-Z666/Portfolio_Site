...
export default function Hero() {
  ...
  return (
    <div className=" flex flex-col w-screen text-center overflow-x-hidden sm:pr-48">
      <div className="flex flex-col h-screen w-screen bg-transparent  sm:px-48 px-6 ">
        <div className="flex flex-col h-screen justify-start items-start">
          <div          
          className=" flex sm:flex-row flex-col-reverse sm:justify-between justify-start sm:gap-48 gap-0  px-2 py-20 sm:pt-32 text-gray-200 h-1/2 text-left z-20 font-satoshi w-full"
        >
