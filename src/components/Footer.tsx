...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { name: 'Email', url: 'mailto:john@example.com', icon: 'M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div ref={contentRef} className="py-16 md:py-20">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-xl font-bold mb-6 font-satoshi">Quick Links</h4>
                ...
                {quickLinks.map((link, index) => (
                  <li key={index}>
                    <a
                      ...
                      className="text-white/70 hover:text-white transition-colors duration-300 cursor-pointer flex items-center group"
                    >
            ...
            {/* Contact Info */}
            <div>
              <h4 className="text-xl font-bold mb-6 font-satoshi">Get In Touch</h4>
              <div className="space-y-4">
                ...
                <div className="flex items-start text-white/70">
                  <svg className="w-5 h-5 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
