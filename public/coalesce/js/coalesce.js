...
function createCanvas() {
  ...
  canvas.a.style = `
    display: none; /* Keep canvas.a hidden if it's only used for rendering */
  `;
  canvas.b.style = `
    position: fixed;
    top: 0;
  ...
  container.appendChild(canvas.a); // Append canvas.a to the DOM
  container.appendChild(canvas.b); // Append canvas.b to the DOM
